...
PROBLEM
-------
- meetups occurs monthly on the same day of the week
- construct objects that represent a meetup date
- each object teakes a month mm
- each object takes year yyyy
- object can determine the date of the meeting in the specified month & year
...
- All the other months -> 31 days
- first day of the week of the month -> 1st and 7th
- second day of the week of the month -> 8th and 14th
- third day of the week of the month -> 15th and 21st
- fourth day of the week of the month -> 22nd and 28th
- fifth day of the week of the month -> 29th and 31st
- last day of the week of the month -> between 22nd and 31st depending on the number of days in the month

EXAMPLES/ TEST CASES
--------------------
- create Meetup class
  - constructor method that takes year, month as arguments
  - day instance method that takes date (string) and description (schedule) as arguments
    - return Date object

DATA STRUCTURES
---------------
- INPUT: date as string and description schedule as string
- OUTPUT: 

- INTERMEDIATE: Date objects
