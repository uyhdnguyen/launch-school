...
# method called rps as follows, which follows the classic 
# rules of rock-paper-scissors game: it returns the winning 
...
# rps(rps(rps("rock", "paper"), rps("rock", "scissors")), "rock") returns "paper"